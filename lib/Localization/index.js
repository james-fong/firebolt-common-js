 ...
 */
(0, _index2.registerEvents)('Localization', Object.values(["postalCodeChanged", "countryCodeChanged", "languageChanged", "localeChanged"]));

function locality() {
  var transforms = null;
  return _index["default"].send('localization', 'locality', {}, transforms);
}
