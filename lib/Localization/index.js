 ...
 */
(0, _index2.registerEvents)('Localization', ["countryCodeChanged", "languageChanged", "localeChanged", "localityChanged", "postalCodeChanged", "preferredAudioLanguagesChanged"]); // onCountryCodeChanged is accessed via listen('countryCodeChanged, ...)
...
function preferredAudioLanguages() {
  var callbackOrValue = arguments[0];
  return _index3["default"].prop('Localization', 'preferredAudioLanguages', {}, callbackOrValue, false, true, 0);
}
