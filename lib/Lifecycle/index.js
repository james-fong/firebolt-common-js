...
(0, _index2.registerEvents)('Lifecycle', ["background", "foreground", "inactive", "suspended", "unloading"]);
var store = {
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.next = 2;
            return (0, _index2.prioritize)('Lifecycle', function (event, value) {
              store._current = event;
            });

          case 2:
            _context.next = 4;
            return _index["default"].send('lifecycle', 'ready', {});
