...
var Transport = /*#__PURE__*/function () {
  ...
  _createClass(Transport, [{
    ...
    value: function constructTransportLayer() {
      ...
      } else if (typeof window.ServiceManager !== 'undefined' && window.ServiceManager && window.ServiceManager.version) {
        // Wire up the queue
        transport = this._queue; // get the default bridge service, and flush the queue

        window.ServiceManager.getServiceForJavaScript(LEGACY_TRANSPORT_SERVICE_NAME, function (service) {
...
window.__firebolt.setTransportLayer = function (transport) {
