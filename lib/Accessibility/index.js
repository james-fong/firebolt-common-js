 ...
 */
(0, _index2.registerEvents)('Accessibility', ["closedCaptionsSettingsChanged", "voiceGuidanceSettingsChanged"]);

_index["default"].registerDeprecatedMethod('Accessibility', 'closedCaptions', 'Use Accessibility.closedCaptionsSettings() instead.');

_index["default"].registerDeprecatedMethod('Accessibility', 'voiceGuidance', 'Use Accessibility.voiceGuidanceSettings() instead.'); // onClosedCaptionsSettingsChanged is accessed via listen('closedCaptionsSettingsChanged, ...)
