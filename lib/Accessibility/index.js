 ...
 */
(0, _index2.registerEvents)('Accessibility', Object.values(["closedCaptionsSettingsChanged", "voiceGuidanceSettingsChanged"]));

_index["default"].registerDeprecatedMethod('Accessibility', 'closedCaptions', 'Use Accessibility.closedCaptionsSettings() instead.');

_index["default"].registerDeprecatedMethod('Accessibility', 'voiceGuidance', 'Use Accessibility.voiceGuidanceSettings() instead.');

function closedCaptions() {
  return _index["default"].send('accessibility', 'closedCaptions', {});
}

function closedCaptionsSettings() {
  return _index3["default"].prop('accessibility', 'closedCaptionsSettings', arguments, false, true);
}

function voiceGuidance() {
  return _index["default"].send('accessibility', 'voiceGuidance', {});
}

function voiceGuidanceSettings() {
  return _index3["default"].prop('accessibility', 'voiceGuidanceSettings', arguments, false, true);
}
