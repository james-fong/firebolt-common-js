...
export module Accessibility {
    ...
    type Event = 'audioDescriptionSettingsChanged' | 'closedCaptionsSettingsChanged' | 'voiceGuidanceSettingsChanged'
...
/**
   ...
   * 
   */
function audioDescriptionSettings(subscriber: (settings: AudioDescriptionSettings) => void): Promise<number>
...
function closedCaptionsSettings(subscriber: (closedCaptionsSettings: ClosedCaptionsSettings) => void): Promise<number>
   ...
   * @param {Function} callback
  */
  function listen(event: 'audioDescriptionSettingsChanged', callback: (data: AudioDescriptionSettings) => void): Promise<number>
   ...
   * @param {Function} callback
  */
function once(event: 'audioDescriptionSettingsChanged', callback: (data: AudioDescriptionSettings) => void): Promise<number>
...
export module Localization {
    ...
    type Event = 'countryCodeChanged' | 'languageChanged' | 'localeChanged' | 'localityChanged' | 'postalCodeChanged' | 'preferredAudioLanguagesChanged'
...
function once(event: 'postalCodeChanged', callback: (data: string) => void): Promise<number>
   ...
   * @param {Function} callback
  */
  function listen(event: 'preferredAudioLanguagesChanged', callback: (data: string[]) => void): Promise<number>
   ...
   * @param {Function} callback
  */
function once(event: 'preferredAudioLanguagesChanged', callback: (data: string[]) => void): Promise<number>
...
/**
   ...
   * 
   */
function preferredAudioLanguages(subscriber: (languages: string[]) => void): Promise<number>
