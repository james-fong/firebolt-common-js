...
/**
 * Inform the platform of the users latest availabilities w/in this app's catalog
 *
 * @param {Availability[]} availabilities Array of availability objects
 */
function availabilities(availabilities: Availability[]): Promise<void>
/**
...
type Event = 'postalCodeChanged' | 'countryCodeChanged' | 'languageChanged' | 'localeChanged'
...
function additionalInfo(): Promise<object>
  ...
  */
   ...
   * @param {Function} listener The listener function to handle the event.
   */
  function listen(event: 'countryCodeChanged', listener: (data: CountryCode) => void): Promise<number>
   ...
   * @param {Function} listener The listener function to handle the event.
   */
  function once(event: 'countryCodeChanged', listener: (data: CountryCode) => void): Promise<number>
   ...
   * @param {Function} listener The listener function to handle the event.
   */
  function listen(event: 'languageChanged', listener: (data: Language) => void): Promise<number>
   ...
   * @param {Function} listener The listener function to handle the event.
   */
  function once(event: 'languageChanged', listener: (data: Language) => void): Promise<number>
   ...
   * @param {Function} listener The listener function to handle the event.
   */
  function listen(event: 'localeChanged', listener: (data: Locale) => void): Promise<number>
   ...
   * @param {Function} listener The listener function to handle the event.
   */
  function once(event: 'localeChanged', listener: (data: Locale) => void): Promise<number>
